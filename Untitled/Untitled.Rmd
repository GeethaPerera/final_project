...
```{r mean and se, eval=TRUE, results='hide'}
ex39_stats <- ex39 %>%
...
```{r, mean dw with se, eval=TRUE, echo= FALSE, results='hide'}
...
```{r 5, out.width='60%', fig.align='center', fig.height= 6, fig.width=8, fig.cap="Mean dry weights",eval=TRUE, echo= FALSE, results='show'}
...
```{r, mean root lengths with se, eval=TRUE, echo= FALSE, results='hide'}
...
```{r 6, out.width='60%', fig.align='center', fig.height= 6, fig.width=8, fig.cap="Mean root lengths",eval=TRUE, echo= FALSE, results='show'}
