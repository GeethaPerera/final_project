...
```{r 3, out.width='60%', fig.align='center', fig.height= 4, fig.width=8, fig.cap="Dry weights",eval=TRUE, echo= FALSE, results='show'}
...
Data on means and standard errors were calculated for each line at each concentration of Aluminium and data were plotted. No effort was made to remove outliers before summarising as the T1 and T2 generations are still segregating and it is possible to see extremes. None of the transgenic lines screened in this particular experiment seems to be performing better in the Aluminium treatments when compared with the control. 
