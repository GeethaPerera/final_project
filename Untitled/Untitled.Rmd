...
```{r 5, out.width='60%', fig.align='center', fig.height= 4, fig.width=6, fig.cap="length of the longest root vs total dry weight"}
...
```{r 6, out.width='60%', fig.align='center', fig.height= 4, fig.width=6, fig.cap="Total root length vs total dry weight"}
