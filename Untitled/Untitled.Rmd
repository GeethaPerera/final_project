...
```{r 6, out.width='60%', fig.align='center', fig.height= 4, fig.width=6, fig.cap="Mean root lengths"}
# root lengths
...
```{r 7, out.width='60%', fig.align='center', fig.height= 4, fig.width=6, fig.cap="length of the longest root vs total dry weight"}
